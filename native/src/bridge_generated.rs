...
fn wire_greet_impl(port_: MessagePort, name: impl Wire2Api<String> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "greet",
            port: Some(port_),
        ...
        move || {
            ...
            move |task_callback| Ok(greet(api_name))
        },
    )
}
...
impl support::IntoDartExceptPrimitive for Components {}
impl rust2dart::IntoIntoDart<Components> for Components {
